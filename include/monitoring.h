...
monitoring_result_t monitoring_update_metrics(monitoring_context_t* ctx,
                                              const char* service_name,
                                              const monitoring_metrics_t* metrics);
monitoring_result_t monitoring_create_alert(monitoring_context_t* ctx,
                                            alert_type_t type,
                                            alert_level_t level,
                                            const char* source,
                                            const char* message,
...
monitoring_result_t
monitoring_get_alerts(monitoring_context_t* ctx, alert_t* alerts, size_t* count);
monitoring_result_t
monitoring_get_metrics(monitoring_context_t* ctx, monitoring_metrics_t* metrics, size_t* count);
